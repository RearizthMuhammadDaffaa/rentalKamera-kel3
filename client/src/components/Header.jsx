...
import { Box ,AppBar,Toolbar,Stack, ListItem, TextField,IconButton, Typography, Container, InputBase} from '@mui/material'
  ...
  return (
    <Box sx={{ display:'flex',justifyContent:'space-between',alignItems:'center',padding:'20px 20px'}}>
      ...
      <InputBase
        ...
        />
        <Search sx={{position:'absolute',top:'14px',left:'5px'}}/>
      </Container>
